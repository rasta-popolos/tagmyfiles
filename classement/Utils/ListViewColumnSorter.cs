...
namespace TagMyFiles
{
    ...
    public class ListViewColumnSorter : IComparer
    {
        ...
        public int Compare(object x, object y)
        {
            ...
            if (listviewX.SubItems[ColumnToSort].Text.ToString().IsNumeric() && listviewX.SubItems[ColumnToSort].Text.ToString().IsNumeric())
            {
                compareResult = ObjectCompare.Compare(
                    listviewX.SubItems[ColumnToSort].Text.ToInt(),
                    listviewY.SubItems[ColumnToSort].Text.ToInt()
                );
            }
            else
            {
